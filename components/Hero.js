  ...
  return (
    <section className="relative overflow-hidden bg-ink text-paper">
      ...
      <div className="relative mx-auto max-w-6xl px-6 py-24 md:py-36">
        <p className="text-brass text-sm font-semibold uppercase tracking-[0.22em] mb-5">Elite beauty professionals</p>
        <h1 className="font-display text-6xl md:text-8xl uppercase leading-[0.88] max-w-3xl">
          Aprendé con los mejores estés donde estés.
        </h1>
        <p className="mt-7 max-w-xl text-paper/85 text-base md:text-lg leading-relaxed">
          WeMaster te acerca a profesores de más de 10 países para que compartan sus conocimientos y experiencias y te conviertas en un Master en Estética.
        </p>
        <a
          href="#cursos"
