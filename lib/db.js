...
export async function getAllEnrollments() {
  const { rows } = await getPostgresPool().query(
    `SELECT enrollments.id, enrollments.course_id, enrollments.full_name,
      enrollments.email, enrollments.phone, enrollments.message,
      enrollments.wants_reminders, enrollments.reminder_sent_at,
      enrollments.payment_status, enrollments.payment_reference,
      enrollments.created_at, courses.title AS course_title
     FROM enrollments
